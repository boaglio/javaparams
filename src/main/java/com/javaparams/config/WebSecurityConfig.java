...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/", "/swagger-ui*/**", "/v3/**", "/rest/actuator/**").permitAll()
                // todo o resto pede autenticação
                .anyRequest().authenticated().and()
                // Form Login: libera página de login
    ...
    public UserDetailsService userDetailsService() {
        ...
        UserDetails user = User.withUsername("fernando")
                .password("{bcrypt}$2a$10$N/JkyAmIDX70am/U3PPP7uiWuRHH9VklzpjKP9ugAe2t6tAnNWLjq").roles("USER").build();
